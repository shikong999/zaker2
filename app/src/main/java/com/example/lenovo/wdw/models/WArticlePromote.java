...
public class WArticlePromote {
    ...
    private String type;
    private WSpecialInfoPromote special_info;
    ...
    public WSpecialInfoPromote getSpecial_info() {
        return special_info;
    }

    public void setSpecial_info(WSpecialInfoPromote special_info) {
